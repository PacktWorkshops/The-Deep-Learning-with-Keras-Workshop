...
class Test(unittest.TestCase):
    ...
    def test_model_1(self):
        ...
        model_1.fit(self.X_train, self.y_train, epochs=300, batch_size=50,
    ...
    def test_model_2(self):
        ...
        # train the model
        model_2.fit(self.X_train, self.y_train, validation_data=(self.X_test, self.y_test),
                    epochs=300, batch_size=50, callbacks=[es_callback], verbose=0)
    ...
    def test_model_3(self):
        ...
        # train the model
        model_3.fit(self.X_train, self.y_train, validation_data=(self.X_test, self.y_test),
                    epochs=300, batch_size=50, callbacks=[es_callback], verbose=0)
